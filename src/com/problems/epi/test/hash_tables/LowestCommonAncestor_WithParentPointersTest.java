...
import com.problems.epi.code.hash_tables.LowestCommonAncestor_WithParentPointers;
...
public class LowestCommonAncestor_WithParentPointersTest {
    ...
    public void findLCATest() {
        ...
        TreeNode actual = LowestCommonAncestor_WithParentPointers.findLCA(root.right.right.right, root.left);
